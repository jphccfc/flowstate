...
export default function AIHubPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="mx-auto w-full max-w-4xl p-4 sm:p-6">
      <div className="mb-6"><div className="workspace-eyebrow mb-2">Client workspace</div><h1 className="workspace-heading text-3xl font-bold">AI Hub</h1><p className="mt-2 max-w-2xl text-sm text-[var(--muted)]">Ask a question about this workspace’s authorized documents, captured inputs, meeting agendas, and client records. Answers are provisional and include source excerpts for review.</p></div>
      <form onSubmit={ask} className="workspace-card p-4 sm:p-6" aria-label="Ask AI Hub">
