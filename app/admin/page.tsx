...
export default function PlatformAdminPage() {
  ...
  return <div className="admin-shell">
    <aside className="admin-rail">
      <div className="admin-rail-header"><Link href="/dashboard" className="workspace-brand"><img src="/flowstate-mark.svg" alt="" className="workspace-brand-mark" /><span className="workspace-brand-name">Flowstate</span></Link></div>
    ...
    <main className="admin-content">
      <header className="admin-header"><div><div className="workspace-eyebrow">Platform control centre</div><h1 className="workspace-heading admin-title">Administration</h1><p className="admin-subtitle">Manage global access and keep an overview of every client organisation.</p></div><div className="admin-status"><span className="admin-status-dot" aria-hidden="true" /> System administrator</div><Link href="/dashboard" className="admin-top-brand" aria-label="Flowstate home"><img src="/flowstate-mark.svg" alt="" className="admin-top-brand-mark" /><span className="admin-top-brand-name">Flowstate</span></Link></header>
