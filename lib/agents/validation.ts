import { AgentType, InputType } from "@/app/generated/prisma/client";

export const safeAgentIdentifier = /^[a-z0-9][a-z0-9._-]{0,63}$/;
const inputTypes = new Set(Object.values(InputType));
const agentTypes = new Set(Object.values(AgentType));
export function validAgentType(value: unknown): value is AgentType { return typeof value === "string" && agentTypes.has(value as AgentType); }
